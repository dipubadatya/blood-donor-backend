...
// // ──────────────────────────────────────────────
// // @route   GET /api/medical/search
// // @desc    Search nearby available donors by blood group & distance
// // @access  Private (medical role only)
// // ──────────────────────────────────────────────
// //
// // Query Parameters:
// //   bloodGroup  — required — e.g. "O+", "A-", "B+"
// //   longitude   — required — medical facility longitude
// //   latitude    — required — medical facility latitude
// //   distance    — optional — search radius in meters (default 5000, range 1000–50000)
// //
// // Example:
// //   GET /api/medical/search?bloodGroup=O+&longitude=77.209&latitude=28.6139&distance=3000
// // ──────────────────────────────────────────────
...
//       return res.status(400).json({
//         success: false,
//         message: "Longitude and latitude are required for geo search",
//       });
//     }
...
//     // ─── Parse Distance (default 5000m, min 1000m, max 50000m) ───
//     let maxDistance = parseInt(distance) || 5000;
//     if (maxDistance < 1000) maxDistance = 1000;
//     if (maxDistance > 50000) maxDistance = 50000;
...
//     // ─── Calculate Approximate Distance For Each Donor ───
...
//       donorObj.distanceInMeters = Math.round(dist);
//       donorObj.distanceInKm = parseFloat((dist / 1000).toFixed(2));

//       return donorObj;
//     });

//     // ─── Sort By Distance (nearest first) — $near already sorts, but let's be explicit ───
...
//     // Handle specific MongoDB geo errors
//     if (error.code === 16755) {
//       return res.status(400).json({
//         success: false,
//         message: "Invalid geospatial data. Ensure location coordinates are correct.",
//       });
//     }
...
// // @desc    Get overall donor statistics
// // @access  Private (medical role only)
// // ──────────────────────────────────────────────
